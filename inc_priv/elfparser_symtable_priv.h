...
#define SYMTABLE_ENTRY_LEN 6


#define SYMTABLE_ENTRY_NAMEIDX_OFF          0x00u
#define SYMTABLE_ENTRY_INFO_OFF_32BIT       0x0Cu
#define SYMTABLE_ENTRY_INFO_OFF_64BIT       0x04u
#define SYMTABLE_ENTRY_OTHER_OFF_32BIT      0x0Du
#define SYMTABLE_ENTRY_OTHER_OFF_64BIT      0x05u
#define SYMTABLE_ENTRY_SECTIDX_OFF_32BIT    0x0Eu
#define SYMTABLE_ENTRY_SECTIDX_OFF_64BIT    0x06u
#define SYMTABLE_ENTRY_VALUE_OFF_32BIT      0x04u
#define SYMTABLE_ENTRY_VALUE_OFF_64BIT      0x08u
#define SYMTABLE_ENTRY_SIZE_OFF_32BIT       0x08u
